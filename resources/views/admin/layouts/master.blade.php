                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="{{route('product#list')}} ">
                                <i class="fa-solid fa-cookie-bite"></i></i>Product
                            </a>
                        </li>
                        <li class="active has-sub">
                        ...
                        <li class="active has-sub">
                            <a class="js-arrow" href="{{route('admin#userMessagePage')}} ">
                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="{{route('admin#account')}}">{{Auth::user()->name}}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="{{route('admin#account')}}">{{Auth::user()->name}}</a>
                                                    </h5>
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{route('admins#changePage')}}">
                                                        <i class="fa-solid fa-key"></i></i> Password</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2">
                                                    ...
                                                    method="post">
                                                        @csrf
                                                        <button type="submit" class="form-control bg-dark text-white"><i class='fa-solid fa-arrow-right-from-bracket mr-2'></i>Logout</button>
                                                    </form>
                                            </div>
                                        </div>
                                    </div>
