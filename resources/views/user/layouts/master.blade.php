                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="btn-group dropstart">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{route('user#editProfilePage')}}">Account</a></li>
                                    <li><a class="dropdown-item" href="{{ route('user#passwordchangePage')}}">Change password</a></li>
                                    <li class="text-center">
                                        <form action="{{ route('logout') }}" method="post" class=" d-inline-block mt-2">
                                            @csrf
                                            <button type="submit" class="btn btn-dark text-white btn-sm">
